<template>
    <div :style="{ width: '100%', height: '100%' }">
      <div>
        ...
        <a-radio-group
          v-model:value="finetunechoice"
          name="radioGroup"
          style="width: 100%"
        >
          <a-row>
            <a-col :span="5">
                <a-radio value="Finetune_v">finetune_v</a-radio>
            </a-col>
            <a-col :span="5">
                <a-radio value="Finetune_t">finetune_t</a-radio>
            </a-col>
            <a-col :span="5">
                <a-radio value="Finetune_vt">finetune_vt</a-radio> 
            </a-col>
            <a-col :span="5">
              <a-button
                type="primary"
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const finetunechoice = ref("Finetune_v")
    ...
    postfine({
        ...
        methods: {
            ...
            'finetune': [finetunechoice.value]
        }
      }).then(res => {

        //console.log(res)

        options = SetOption(res.data, 'fine')
        //console.log(options)
